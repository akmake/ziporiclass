...
// === מטריצת הרשאות: מי יכול לדבר עם מי ===
...
export const getMyContacts = async (req, res) => {
    ...
    // שליפת אנשי קשר (לא כולל את עצמי)
